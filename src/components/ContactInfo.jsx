  ...
  const contactInfo = [
    {
      ...
      label: "LinkedIn",
      value: "osheen-ahmed",
      link: "https://www.linkedin.com/in/osheen-ahmed-9279b2255/",
      delay: 0.1,
    },
    {
      icon: Github,
      label: "GitHub",
      value: "Osheenahmad",
      link: "https://github.com/Osheenahmad",
      delay: 0.2,
    },
    {
      icon: Mail,
      label: "Email",
      value: "osheenahmad32.jwr@gmail.com",
      link: "mailto:osheenahmad32@gmail.com",
      delay: 0.3,
    },
    {
      icon: Phone,
    ...
    <section id="contact-info" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <a href="mailto:osheenahmad32@gmail.com">
